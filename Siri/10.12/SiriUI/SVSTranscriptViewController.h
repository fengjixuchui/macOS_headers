...
@class NSClickGestureRecognizer, NSCollectionView, NSMutableDictionary, NSMutableSet, NSString, NSUUID, SVSSuggestionsViewController, SVSTranscript, SVSTranscriptAnimationQueue, SVSTranscriptFlowLayout, SVSTranscriptView, SiriUIClumpView, SiriUINavigationController, SiriUITranscriptItem;
