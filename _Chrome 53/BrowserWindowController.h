...
#import "BookmarkBarControllerDelegate.h"
#import "TabStripControllerDelegate.h"
...
@interface BrowserWindowController : TabWindowController <BookmarkBarControllerDelegate, ViewResizer, TabStripControllerDelegate>
{
    ...
    struct scoped_nsobject<PresentationModeController> presentationModeController_;
    ...
    struct scoped_nsobject<NSView> floatingBarBackingView_;
    ...
    struct scoped_nsobject<NSMutableSet> barVisibilityLocks_;
    BOOL barVisibilityUpdatesEnabled_;
    BOOL blockLayoutSubviews_;
    struct unique_ptr<ExtensionKeybindingRegistryCocoa, std::__1::default_delete<ExtensionKeybindingRegistryCocoa>> extension_keybinding_registry_;
}
...
- (struct CGRect)selectedTabGrowBoxRect;
...
- (void)releaseBarVisibilityForOwner:(id)arg1 withAnimation:(BOOL)arg2 delay:(BOOL)arg3;
- (void)lockBarVisibilityForOwner:(id)arg1 withAnimation:(BOOL)arg2 delay:(BOOL)arg3;
- (BOOL)isBarVisibilityLockedForOwner:(id)arg1;
...
- (void)setFullscreenToolbarVisible:(BOOL)arg1;
- (BOOL)exitExtensionFullscreenIfPossible;
- (void)updateFullscreenExitBubble;
- (void)updateFullscreenWithToolbar:(BOOL)arg1;
- (void)enterBrowserFullscreenWithToolbar:(BOOL)arg1;
...
- (struct PermissionBubbleManager *)permissionBubbleManager;
...
- (void)hideOverlayIfPossibleWithAnimation:(BOOL)arg1 delay:(BOOL)arg2;
...
- (id)newPresentationModeControllerWithStyle:(int)arg1;
- (void)adjustUIForSlidingFullscreenStyle:(int)arg1;
- (void)adjustUIForExitingFullscreenAndStopOmniboxSliding;
- (void)configurePresentationModeController;
- (void)permissionBubbleWindowWillClose:(id)arg1;
