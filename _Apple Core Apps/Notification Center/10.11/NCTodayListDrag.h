...
@property(retain, nonatomic) _NCTodayListPlaceholder *destinationPlaceholder; // @synthesize destinationPlaceholder=_destinationPlaceholder;
@property(retain, nonatomic) _NCTodayListContainer *destinationContainer; // @synthesize destinationContainer=_destinationContainer;
@property(retain, nonatomic) _NCTodayListPlaceholder *sourcePlaceholder; // @synthesize sourcePlaceholder=_sourcePlaceholder;
@property(retain, nonatomic) _NCTodayListContainer *sourceContainer; // @synthesize sourceContainer=_sourceContainer;
