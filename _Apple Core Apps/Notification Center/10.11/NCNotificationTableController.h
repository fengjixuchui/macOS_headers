...
#import "NCNotificationCenterTabProtocol.h"
#import "NCTableViewDelegate.h"
#import "NSTableViewDataSource.h"

@class NCDNDViewController, NCNotificationTableCellView, NCTableCellView, NCTableView, NCTexturedView, NSAppTableCellView, NSMutableArray, NSObject<OS_dispatch_source>, NSScrollView, NSString, NSTextField, NSTrackingArea, NSView;

@interface NCNotificationTableController : NSViewController <NCTableViewDelegate, NSTableViewDataSource, NCNotificationCenterDelegate, NCNotificationCenterTabProtocol>
{
...
@property(nonatomic) NSTextField *noMessagesTF; // @synthesize noMessagesTF=_noMessagesTF;
@property(retain, nonatomic) NSScrollView *tableScrollView; // @synthesize tableScrollView=_tableScrollView;
@property(retain, nonatomic) NCTableView *tableView; // @synthesize tableView=_tableView;
