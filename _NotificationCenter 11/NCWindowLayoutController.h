...
#import "NCCAControllerDelegate.h"

@class NCBannerModel, NCBannerWindowController, NCNotificationWindow, NCRemotePlugInManager, NSHashTable, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_source>, NSString, NSWindow;
...
- (void).cxx_destruct;
- (void)NCCAController:(id)arg1 dismissRemoteSession:(id)arg2 withAnimation:(_Bool)arg3;
...
- (void)bannerClose:(id)arg1 allowsPoof:(_Bool)arg2;
