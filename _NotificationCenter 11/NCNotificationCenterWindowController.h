...
#import "_NCWindowDelegate.h"

@class NCConfigButton, NCLineView, NCNotificationTabContainer, NCNotificationTableController, NCShadowTextFieldCell, NCTexturedView, NCTodayConfigurationViewController, NCTodayViewController, NSButton, NSLayoutConstraint, NSObject<OS_dispatch_source>, NSSegmentedControl, NSString, NSToolbar, NSTrackingArea, NSView, NSViewController;

@interface NCNotificationCenterWindowController : NSWindowController <_NCWindowDelegate>
{
...
@property(readonly, nonatomic) NCNotificationTableController *tableController; // @synthesize tableController=_tableController;
