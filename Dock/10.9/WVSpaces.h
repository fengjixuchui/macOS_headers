...
@interface WVSpaces : NSObject <DOCKGestureHandler>
{
    ...
    _Bool _spacesSpansDisplays;
    _Bool _needToUpdateSpaces;
    _Bool _needToUpdateDesktopPicture;
    _Bool _logSpaceSwitchNotifications;
}

@property(readonly, nonatomic) _Bool spacesSpansDisplays; // @synthesize spacesSpansDisplays=_spacesSpansDisplays;
...
- (void)_initializeSpaces:(id)arg1;
...
@property(readonly, nonatomic) NSString *debugDescription; // @dynamic debugDescription;
