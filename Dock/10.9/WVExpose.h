...
@class CALayer, ECCoverFlow, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSMutableString, NSObject<OS_dispatch_source>, Tile, WAWindow, WVDisplay, WVDragWindow, WVExposeSeparatorLayer, WVHotCorners, WVNewExposeWindowsLayer, _CGSSpace, _WVGestureInfo;
...
- (void)_missionControlScaleDownDesktopWindowsForDisplay:(id)arg1;
...
- (void)_setupWindowsPerDisplayPerSpacesWithTags:(int [2])arg1 clearTags:(int [2])arg2;
...
- (id)_scaledDesktopWindowForSpace:(id)arg1 onDisplay:(id)arg2 immediate:(BOOL)arg3;
