...
@class CALayer, DOCKGridLayer, DOCKStackBackgroundLayer, DOCKStackExpandedItemLayer, DOCKStackGridHoverLayer, ECScrollbarLayer, ECShadowTextLayer, ECTextLayer, NSObject<OS_dispatch_source>;
...
@property(retain, nonatomic) ECTextLayer *titleTextLayer; // @synthesize titleTextLayer=_titleTextLayer;
- (id)rotationLayer;
