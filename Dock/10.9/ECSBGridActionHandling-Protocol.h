...
- (void)hideGroup:(ECSBGroup *)arg1 withOffset:(double)arg2 sender:(id)arg3;
- (void)showGroup:(ECSBGroup *)arg1 withOffset:(double)arg2 sender:(id)arg3;
- (void)prepareToShowGroup:(ECSBGroup *)arg1 atRect:(struct CGRect)arg2 withOffset:(double)arg3 sender:(id)arg4;
