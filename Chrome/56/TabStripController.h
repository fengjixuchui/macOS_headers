...
#import <Google Chrome Framework/TabControllerTarget-Protocol.h>
...
@interface TabStripController : NSObject <TabControllerTarget, URLDropTargetController, HasWeakBrowserPointer>
{
    ...
    NSView *switchView_;
    scoped_nsobject_7ff2efe9 dragBlockingView_;
    ...
    TabView *hoveredTab_;
    scoped_nsobject_7ff2efe9 toolTipView_;
...
- (id)iconImageForContents:(struct WebContents *)arg1 atIndex:(long long)arg2;
