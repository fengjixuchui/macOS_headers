...
#import <Google Chrome Framework/NSTouchBarDelegate-Protocol.h>
#import <Google Chrome Framework/NSUserInterfaceValidations-Protocol.h>

@class NSEvent, NSString;

__attribute__((visibility("hidden")))
@interface BridgedContentView : ToolTipBaseView <NSTouchBarDelegate, NSTextInputClient, NSUserInterfaceValidations, NSDraggingSource>
{
...
- (void)insertTextInternal:(id)arg1;
...
- (void)handleKeyEvent:(struct KeyEvent *)arg1;
- (struct MenuController *)activeMenuController;
...
- (struct NSObject *)makeTouchBar;
- (struct NSObject *)touchBar:(struct NSObject *)arg1 makeItemForIdentifier:(id)arg2;
- (void)touchBarButtonAction:(id)arg1;
