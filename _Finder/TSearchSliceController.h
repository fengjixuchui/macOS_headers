...
{
    struct TNSRef<NSStackView *> _slicesStackView;
    struct TNSRef<TSearchForSliceController *> _searchForSliceController;
    struct TNSRef<TSearchScopeSliceController *> _scopeSliceController;
    struct TNSRef<TSearchCriteriaViewController *> _criteriaController;
    NSSearchField *_toolbarSearchField;
    TBrowserContainerController *_containerController;
    struct TNSRef<NSSet *> _searchFilterUTIs;
    _Bool _isSaveable;
    _Bool _configuring;
}
