...
- (void)drawArcs;
- (void)drawCircles;
@property(readonly, nonatomic) struct CGRect documentFrame; // @dynamic documentFrame;
...
@property(readonly, nonatomic) struct CGRect layoutFrame; // @dynamic layoutFrame;
