...
@class NSImage, NSString, TMeetingRoomAreYouSureViewController, TMeetingRoomAskUserViewController, TMeetingRoomErrorViewController, TMeetingRoomProgressController, TMeetingRoomStatusViewController, TMeetingRoomWaitingViewController, TView;
...
@interface IMeetingRoomProgressViewController : TViewController <TNWOperationDelegateProtocol>
{
    ...
    struct TNSRef<NSImage *> _mediumImage;
