...
@interface TSidebarViewController : TViewController <NSOutlineViewDataSource, TSidebarViewDelegate, NSMenuDelegate, TSpringDelegate, ISpawnOriginDelegateProtocol, QLSeamlessCloserDelegate>
{
    ...
    struct TNSRef<TICloudProgressObserver *> _iCloudObserver;
    ...
    struct TNSRef<NSTimer *> _iCloudAnimationTimer;
}
...
- (id)buttonImageForActionKind:(int)arg1 mouseState:(int)arg2;
