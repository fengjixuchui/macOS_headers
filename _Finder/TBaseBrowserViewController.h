...
@interface TBaseBrowserViewController : TViewController <NSDraggingSource, NSSharingServiceDelegate, NSSharingServicePickerDelegate, TBrowserViewDelegateProtocol, TDropOperationDelegateProtocol, TNodeTaskDelegateProtocol, TQLPreviewWindowControllerProtocol, TGroupAsFolderDelegate, TSpringDelegate, TTypeSelectDelegate, TValidatorClientProtocol, TFloatingInputWindowDelegateProtocol>
{
    ...
    struct TNSRef<NSSharingServicePicker *> _toolbarSharingServicePicker;
