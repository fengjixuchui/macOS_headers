...
@class NSDictionary, NSString, TListHeaderRowView, TListNameField, TListTableColumn;
...
@interface TListViewController : TBrowserViewController <NSOutlineViewDelegate, NSTableViewDelegate, NSOutlineViewDataSource, NSWindowDelegate, NSScrollViewDelegate>
{
    ...
    struct TNSRef<TValidatingDateFormatter *> _shortDateFormatter;
    struct TNSRef<TValidatingDateFormatter *> _shortDateWithTimeFormatter;
    struct TNSRef<TValidatingDateFormatter *> _mediumDateFormatter;
    struct TNSRef<TValidatingDateFormatter *> _longDateFormatter;
    ...
    struct TNSRef<NSDictionary *> _columnSettings;
    ...
    _Bool _editing;
    struct TNSRef<TListNameField *> _originalEditedNameField;
    ...
    struct TNSRef<TListHeaderRowView *> _headerRowView;
    struct TNSRef<NSFont *> _monospacedCellViewFont;
    struct TNSRef<NSFont *> _cellViewFont;
...
@property(retain, nonatomic) TListNameField *originalEditedNameField; // @dynamic originalEditedNameField;
