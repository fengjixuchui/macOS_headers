...
@interface TSearchCriteriaViewController : TViewController <NSTextFieldDelegate, NSRuleEditorDelegate, TSearchCriteriaSheetDelegate>
{
    ...
    struct TNSRef<NSMutableArray *> _customFieldsArray;
    struct TNSRef<NSArray *> _rootSliceAttributes;
    struct TNSRef<NSMutableArray<NSMutableDictionary *>*> _boundRulesArray;
    struct TNSRef<TSearchCriteriaSheetController *> _sheetController;
    struct TNSRef<TMDUserSearch *> _search;
}
