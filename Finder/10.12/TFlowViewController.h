...
{
    struct TNSRef<TFlowSplitViewController *> _splitViewController;
    struct TNSRef<NSLayoutConstraint *> _splitViewTopConstraint;
    double _topContentInset;
    struct TNSRef<TListTableColumn *> _genericTextColumnRetainer;
    struct TNSRef<TListTableColumn *> _genericDateColumnRetainer;
    struct TNSRef<TListTableColumn *> _genericNumericColumnRetainer;
    struct TNSRef<TFlowView *> _flowView;
