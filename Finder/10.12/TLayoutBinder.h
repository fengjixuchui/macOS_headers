...
@interface TLayoutBinder : NSObject <NSCopying>
{
    ...
    struct unordered_map<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>, std::__1::hash<TNSRef<NSView *>>, std::__1::equal_to<TNSRef<NSView *>>, std::__1::allocator<std::__1::pair<const TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>>> _observedMasterViews;
}
