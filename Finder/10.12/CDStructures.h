...
@class CAContext, CALayer, DMCoreStorage, IActionButtonCell, IPropertyValueApplicator, IPropertyValueExtractor, NSArray, NSArrayController, NSButton, NSColor, NSData, NSDate, NSDateComponents, NSDictionary, NSEnumerator, NSEvent, NSFont, NSFormatter, NSImage, NSImmediateActionGestureRecognizer, NSIndexSet, NSLayoutConstraint, NSLayoutManager, NSMenu, NSMetadataQuery, NSMutableArray, NSMutableDictionary, NSMutableIndexSet, NSMutableOrderedSet, NSMutableSet, NSObject, NSObject<NSCopying>, NSOperationQueue, NSPasteboard, NSSet, NSSharingServicePicker, NSSplitViewItem, NSStackView, NSString, NSTextContainer, NSTextStorage, NSTimer, NSTrackingArea, NSURL, NSURLConnection, NSUbiquitousKeyValueStore, NSView, NSViewController, NSVisualEffectView, NSWindow, QLInlinePreviewController, QLPreviewPanel, SFAirDropDiscoveryController, SFWirelessSettingsController, TAirDropDiscoverableModePopoverViewController, TAirDropDiscoveryController, TAirDropInfoViewController, TAirDropLayoutController, TAirDropLegacyModePopoverViewController, TAirDropNotAvailableViewController, TAirDropPerson, TAirDropProgressLayer, TBVDSBulkConfigChangedState, TBackupContainerDelegate, TBaseBrowserWindowController, TBasicImageView, TBottomBarController, TBrowserContainerController, TBrowserImmediateActionGestureRecognizerDelegate, TBrowserSplitViewController, TBrowserViewContainerController, TBrowserViewController, TBrowserViewDataSource, TBrowserViewSwitchAnimator, TBulkRenameController, TButton, TClipImageView, TColumnPreviewController, TCustomWherePathTextView, TDelayedPopulationViewController, TDesktopBandSelectionController, TDesktopGridLayoutController, TDesktopIcon, TDesktopIconSelectionView, TDesktopIconSpatialDataController, TDesktopInlinePreviewController, TDesktopInlineProgressView, TDesktopMultiViewController, TDesktopSubtitleTextField, TDesktopTitleBubbleView, TDesktopViewController, TDesktopViewDataSource, TFavoriteServersTableViewController, TFileSizeFormatter, TFloatingInputView, TFlowSplitViewController, TFlowView, TGradientSeparator, TGroupInFolderAnimationController, TICloudAccountManager, TICloudNoDocumentsViewController, TICloudProgressObserver, TIconView, TIconViewCellOffscreenRenderer, TIconViewSettings, TImageView, TInlineCancelButtonLayer, TInlinePreviewData, TInlineProgressBarLayer, TInlineProgressHostLayer, TInternalCloudProgressObserver, TLayer, TLayoutBinder, TListHeaderCellView, TListHeaderRowView, TListNameField, TListTableColumn, TListViewSettings, TMDUserSearch, TMidnightTimer, TNodeViewSettings, TNotificationCenterObserverGlue, TOpenWithMenuFactory, TOpenWithPopupMenuController, TPopover, TPopoverController, TProgressStatusViewController, TPropertyLogicalSizeExtractor, TQLPreviewViewZoomController, TQueuedPopoverController, TRenameOperation, TScrollView, TSearchCriteriaSheetController, TSearchCriteriaViewController, TSearchForSliceController, TSearchScopeSliceController, TSearchSliceController, TShrinkToFitController, TShrinkToFitWindow, TSidebarSplitViewController, TSidebarViewController, TSingleLineTabViewController, TStatusBarController, TTabViewController, TTabViewCoverLayer, TTabViewItem, TTabViewSingleLineView, TTagColumnTableViewController, TTagEditorController, TTagInfo, TTagOperationDelegate, TTagSuggestionsWindowController, TTaggingSuggestionsViewController, TTargetActionFunctor, TTextField, TTextWithTitleFieldImpl, TTitleField, TToolbarController, TUpdateLayerView, TValidatingDateFormatter, TView, TViewController, TWindowHistory;
...
struct TFullScreenAnimationInfo {
    ...
    _Bool _field28;
    _Bool _field29;
    struct TNSRef<TView *> _field30;
    struct TNSRef<CALayer *> _field31;
    struct TNSRef<TView *> _field32;
    struct TNSRef<NSVisualEffectView *> _field33;
    struct CGRect _field34;
    struct TNSRef<NSVisualEffectView *> _field35;
    double _field36;
    double _field37;
...
struct TNSRef<IPropertyValueApplicator *> {
...
struct TNSRef<NSMutableArray<NSMutableDictionary *>*> {
    NSMutableArray *fRef;
};
...
struct TNSRef<NSSplitViewItem *> {
    NSSplitViewItem *fRef;
};

struct TNSRef<NSStackView *> {
    NSStackView *fRef;
};
...
struct TNSRef<NSViewController *> {
...
struct TNSRef<TAirDropNotAvailableViewController *> {
...
struct TNSRef<TBVDSBulkConfigChangedState *> {
...
struct TNSRef<TBottomBarController *> {
    TBottomBarController *fRef;
};

struct TNSRef<TBrowserContainerController *> {
...
struct TNSRef<TBrowserSplitViewController *> {
    TBrowserSplitViewController *fRef;
};

struct TNSRef<TBrowserViewContainerController *> {
    TBrowserViewContainerController *fRef;
};

struct TNSRef<TBrowserViewController *> {
...
struct TNSRef<TButton *> {
    TButton *fRef;
};

struct TNSRef<TClipImageView *> {
    TClipImageView *fRef;
};
...
struct TNSRef<TDesktopInlineProgressView *> {
...
struct TNSRef<TFlowSplitViewController *> {
    TFlowSplitViewController *fRef;
};

struct TNSRef<TFlowView *> {
    TFlowView *fRef;
};
...
struct TNSRef<TICloudProgressObserver *> {
...
struct TNSRef<TInternalCloudProgressObserver *> {
...
struct TNSRef<TListHeaderRowView *> {
    TListHeaderRowView *fRef;
};

struct TNSRef<TListNameField *> {
    TListNameField *fRef;
};

struct TNSRef<TListTableColumn *> {
...
struct TNSRef<TNotificationCenterObserverGlue *> {
...
struct TNSRef<TSearchCriteriaSheetController *> {
    TSearchCriteriaSheetController *fRef;
};

struct TNSRef<TSearchCriteriaViewController *> {
    TSearchCriteriaViewController *fRef;
};

struct TNSRef<TSearchForSliceController *> {
    TSearchForSliceController *fRef;
};

struct TNSRef<TSearchScopeSliceController *> {
    TSearchScopeSliceController *fRef;
};

struct TNSRef<TSearchSliceController *> {
...
struct TNSRef<TSidebarSplitViewController *> {
...
struct TNSRef<TStatusBarController *> {
...
struct TNotificationCenterObserver {
    struct TNSRef<TNotificationCenterObserverGlue *> fFunctorGlue;
    struct TString fNotificationName;
    id fObject;
    _Bool fGlobalObserver;
};
...
struct __hash_node<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, void *>;
...
struct __hash_node<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, void *>;
...
struct function<NSImage *(MouseState)> {
    struct type __buf_;
    struct __base<NSImage *(MouseState)> *__f_;
};

struct function<NSImage *(MouseState, TSidebarActionKind)> {
    struct type _field1;
    struct __base<NSImage *(MouseState, TSidebarActionKind)> *_field2;
};
...
struct function<NSImage *(bool, bool, TString &)> {
    struct type __buf_;
    struct __base<NSImage *(bool, bool, TString &)> *__f_;
};
...
struct unique_ptr<std::__1::__hash_node<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, void *>*[], std::__1::__bucket_list_deallocator<std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, void *>*>>> {
    struct __compressed_pair<std::__1::__hash_node<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, void *>**, std::__1::__bucket_list_deallocator<std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, void *>*>>> {
        struct __hash_node<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, void *> **__first_;
        struct __bucket_list_deallocator<std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, void *>*>> {
            struct __compressed_pair<unsigned long, std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, void *>*>> {
                unsigned long long __first_;
            } __data_;
        } __second_;
    } __ptr_;
...
struct unique_ptr<std::__1::__hash_node<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, void *>*[], std::__1::__bucket_list_deallocator<std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, void *>*>>> {
    struct __compressed_pair<std::__1::__hash_node<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, void *>**, std::__1::__bucket_list_deallocator<std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, void *>*>>> {
        struct __hash_node<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, void *> **__first_;
        struct __bucket_list_deallocator<std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, void *>*>> {
            struct __compressed_pair<unsigned long, std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, void *>*>> {
                unsigned long long __first_;
            } __data_;
        } __second_;
    } __ptr_;
...
struct unordered_map<TFENode, TNSRef<TBVDSBusyStateIncrementer *>, std::__1::hash<TFENode>, std::__1::equal_to<TFENode>, std::__1::allocator<std::__1::pair<const TFENode, TNSRef<TBVDSBusyStateIncrementer *>>>> {
    struct __hash_table<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, std::__1::__unordered_map_hasher<TFENode, std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, std::__1::hash<TFENode>, true>, std::__1::__unordered_map_equal<TFENode, std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, std::__1::equal_to<TFENode>, true>, std::__1::allocator<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>>> {
        struct unique_ptr<std::__1::__hash_node<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, void *>*[], std::__1::__bucket_list_deallocator<std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, void *>*>>> __bucket_list_;
        struct __compressed_pair<std::__1::__hash_node_base<std::__1::__hash_node<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, void *>*>, std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, void *>>> {
            struct __hash_node_base<std::__1::__hash_node<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, void *>*> {
                struct __hash_node<std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, void *> *__next_;
            } __first_;
        } __p1_;
        struct __compressed_pair<unsigned long, std::__1::__unordered_map_hasher<TFENode, std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, std::__1::hash<TFENode>, true>> {
            unsigned long long __first_;
        } __p2_;
        struct __compressed_pair<float, std::__1::__unordered_map_equal<TFENode, std::__1::__hash_value_type<TFENode, TNSRef<TBVDSBusyStateIncrementer *>>, std::__1::equal_to<TFENode>, true>> {
            float __first_;
        } __p3_;
    } __table_;
};
...
struct unordered_map<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>, std::__1::hash<TNSRef<NSView *>>, std::__1::equal_to<TNSRef<NSView *>>, std::__1::allocator<std::__1::pair<const TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>>> {
    struct __hash_table<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, std::__1::__unordered_map_hasher<TNSRef<NSView *>, std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, std::__1::hash<TNSRef<NSView *>>, true>, std::__1::__unordered_map_equal<TNSRef<NSView *>, std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, std::__1::equal_to<TNSRef<NSView *>>, true>, std::__1::allocator<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>>> {
        struct unique_ptr<std::__1::__hash_node<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, void *>*[], std::__1::__bucket_list_deallocator<std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, void *>*>>> __bucket_list_;
        struct __compressed_pair<std::__1::__hash_node_base<std::__1::__hash_node<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, void *>*>, std::__1::allocator<std::__1::__hash_node<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, void *>>> {
            struct __hash_node_base<std::__1::__hash_node<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, void *>*> {
                struct __hash_node<std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, void *> *__next_;
            } __first_;
        } __p1_;
        struct __compressed_pair<unsigned long, std::__1::__unordered_map_hasher<TNSRef<NSView *>, std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, std::__1::hash<TNSRef<NSView *>>, true>> {
            unsigned long long __first_;
        } __p2_;
        struct __compressed_pair<float, std::__1::__unordered_map_equal<TNSRef<NSView *>, std::__1::__hash_value_type<TNSRef<NSView *>, std::__1::pair<unsigned long, TNotificationCenterObserver>>, std::__1::equal_to<TNSRef<NSView *>>, true>> {
            float __first_;
        } __p3_;
    } __table_;
};
...
typedef struct function<NSImage *(MouseState)> {
    struct type __buf_;
    struct __base<NSImage *(MouseState)> *__f_;
} function_1bd45014;

typedef struct function<NSImage *(MouseState, TSidebarActionKind)> {
    struct type _field1;
    struct __base<NSImage *(MouseState, TSidebarActionKind)> *_field2;
} function_ab83811b;
...
typedef struct function<NSImage *(bool, bool, TString &)> {
    struct type __buf_;
    struct __base<NSImage *(bool, bool, TString &)> *__f_;
} function_09775cf3;
