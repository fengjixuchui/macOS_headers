...
@interface BlinkScrollbarPainterDelegate : NSObject <NSAnimationDelegate>
{
    ...
    RetainPtr_ef99e9ef _knobAlphaAnimation;
    RetainPtr_ef99e9ef _trackAlphaAnimation;
    RetainPtr_ef99e9ef _uiStateTransitionAnimation;
    RetainPtr_ef99e9ef _expansionTransitionAnimation;
...
- (void)setUpAlphaAnimation:(RetainPtr_ef99e9ef *)arg1 scrollerPainter:(id)arg2 part:(int)arg3 animateAlphaTo:(double)arg4 duration:(double)arg5;
